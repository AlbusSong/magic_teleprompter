...
import 'animation/easy_flip_diamond.dart';
import 'animation/easy_rain_couplet.dart';
import 'animation/easy_creeping_bug.dart';
import 'animation/easy_dancing_ball.dart';
import 'animation/easy_dancing_cube.dart';
import 'animation/easy_falling_ball.dart';
import 'animation/easy_flashing_circles.dart';
import 'animation/easy_hourglass_timer.dart';
import 'animation/easy_moving_cube.dart';
import 'animation/easy_rotating_two_color_circles.dart';
import 'animation/easy_rubber_band.dart';
import 'animation/easy_spit_bubbles.dart';
import 'animation/easy_pendulum_ball.dart';
import 'animation/easy_swimming_ball.dart';
import 'animation/easy_waves.dart';
...
//          value: Provider.of<EasyHub>(context, listen: false).value,
      ...
      case EasyHubIndicatorType.EasyHubIndicator_movingCube: //水球滴水
        _indicator = EasyMovingCube(
          width: 20,
          topColor: hexColor("00CDD4"),
          leftColor: hexColor("206B6D"),
        );
        break;
    ...
    switch (_easyHubType) {
      ...
      case EasyHubType.EasyHub_all:
        _children.add(Container(
            padding: EdgeInsets.fromLTRB(40, 15, 40, 5), child: _indicator));
        _children.add(Container(
      ...
      case EasyHubType.EasyHub_just:
        _children.add(Container(
            padding: EdgeInsets.fromLTRB(30, 20, 30, 20), child: _indicator));
